...
lab="/home/festo/Documents/HakyIm/QGT-Columbia-HKI-repo"
...
PRE="/home/festo/Documents/HakyIm/QGT-Columbia-HKI"
...
export LAB="/home/festo/Documents/HakyIm/QGT-Columbia-HKI-repo"
export PRE="/home/festo/Documents/HakyIm/QGT-Columbia-HKI"
...
- before you run multixcan ensure you have run s-predixcan for all the tissues you want to run multixcan. In this tutorial ensure you have run s-predixcan with the liver model first before running multixcan. Another thing to note is to ensure similar naming pattern for the output file to ensure the files are captured correctly when running multixcan.
