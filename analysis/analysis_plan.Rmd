...
workaround: in the Rstudio server (http://104.154.186.85:8787/) For the terminal to work properly we need to run
...
TORUSOFT=$PRE/repos/torus-master/src/torus.static

$TORUSOFT -d $PRE/fastenloc/data/Height.torus.zval.gz --load_zval -dump_pip $PRE/fastenloc/data/Height.gwas.pip
cd $PRE/fastenloc/data
gzip Height.gwas.pip
cd $PRE
...
export eqtl_annotation_gzipped=$PRE/fastenloc/data/FASTENLOC-gtex_v8.eqtl_annot.vcf.gz
export gwas_data_gzipped=$PRE/fastenloc/data/Height.gwas.pip.gz
